...
function addNumbers(num1: number, num2: number): number {
    ...
    // 'return' statement is used to exit the function and send a value back to the caller
    // Here, the sum of num1 and num2 is returned
    return num1 + num2;
}

// Calling the function with two numbers and logging the result
// 'console.log' is used to display the output in the console
