...
function executeCallback(
    callback: (arg1: number, arg2: number) => void, // Define a function parameter 'callback' that takes two numbers and returns nothing
    arg1: number, // Define the first argument
    arg2: number // Define the second argument
  ): void {
